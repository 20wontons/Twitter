...
data class Tweet(
    ...
    companion object {
        fun fromJson(jsonObject: JSONObject) : Tweet {
            ...
            tweet.likeCount = jsonObject.getInt("favorite_count") // TODO issue: when retweeted, no likes are displayed
            tweet.retweeted = jsonObject.getBoolean("retweeted")
            tweet.liked = jsonObject.getBoolean("favorited") // TODO issue: when null, the tweet is erroneously liked
